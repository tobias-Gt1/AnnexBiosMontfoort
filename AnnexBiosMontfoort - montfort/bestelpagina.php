    ...
    <main>
        ...
        if ($result) {
            while ($row = mysqli_fetch_assoc($result)) {
                // Voeg de chair_id toe aan de array
                $takenStoelen[] = $row['chair_id'];
            }

            // Debug: toon de array met alle stoelen
        } else {
            echo "Fout bij query: " . mysqli_error($conn);
        }
            ...
            <div class="allSteps">
                <div class="step1">
                    ...
                    <div class="ticket-row">
                        ...
                        <span>
                            <span>€9,00</span>
                            <span class="aantal"> <input name="normal" type="number" style="width: 75px;" value="0" min="0"></span>
                    </div>
                    ...
                    <div class="ticket-row">
                        ...
                        <span>
                            <span>€5,00</span>
                            <span class="aantal"> <input name="child" type="number" style="width: 75px;" value="0" min="0"></span>
                    </div>
                    ...
                    <div class="ticket-row">
                        ...
                        <span>
                            <span>€7,00</span>
                            <span class="aantal"> <input name="senior" type="number" style="width: 75px;" value="0" min="0"></span>
                        </span>
                    </div>
                ...
                <div class="step2">
                    ...
                    <input type="hidden" name="selectedSeats" id="selectedSeatsInput" value="0">
                ...
                <div class="booking-container">
                    ...
                    <h1 class="step-title">STAP 3: CONTROLEER JE BESTELLING</h1>

                    <div class="movie-details">
                        <div class="movie-poster">
                            <img src="fotos/poster-placeholder.png" alt="film poster">
                        </div>
                    ...
                    <h1 class="step-title">STAP 4: VUL JE GEGEVENS IN</h1>
                    ...
                    <h1 class="step-title">STAP 5: KIES JE BETAALWIJZE</h1>
                    ...
                    <button type="submit" name="bestellen" id="reserveer" class="checkout-btn">AFREKENEN</button>
                </div>
                <form action=""> </form>
    </main>
</body>
